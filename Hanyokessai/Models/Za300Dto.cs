...
namespace Hanyokessai.Models
{
    public class Za300Dto
    {
        ...
        [Required(ErrorMessage = "会社コードを選択してください。")]
        [RegularExpression("^[A-Z]+$", ErrorMessage = "会社に誤りがあります。")]
        ...
        [Required(ErrorMessage = "押印情報有無を入力してください。")]
        public IFormFile imgStamp { get; set; }

        public string txtRegisterId { get; set; }

        public string txtRegisterDay { get; set; }

        public string txtDelCode { get; set; }
