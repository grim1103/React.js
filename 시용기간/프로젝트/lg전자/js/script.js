...
$(document).ready(function(){
    $('.f_left_img_place').hover(function(){
        $(this).children('.f_left_text').animate({opacity: '.5'}, 300);
        

    });
    $('.f_left_img_place').mouseleave(function(){
        // $(this).css('background-color','none');
        $(this).children('.f_left_text').animate({opacity: '0'})
    });
